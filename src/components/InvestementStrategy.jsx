...
export default function InvestementStrategy() {
  ...
  return (
    <section class=" InvestementStrategy bg-white overflow-visible pt-[150px] pb-[150px] px-0">
      <div className="container">
        <div className="intro  mb-[110px] text-center ">
          ...
          <p class="text-[#0D0D0D] text-center font-montserrat text-[17px] font-normal leading-[150%] tracking-[0.7px]  max-w-[824px] mt-4 mx-auto">
              ...
              ${
                isActive ? "border-b-[rgb(0,191,200)]" : "border-b-transparent"
                  ...
                  >
                    ...
                    {isActive && (
                      <p className="mt-4 text-[color:var(--Primary-Black,#0D0D0D)] font-montserrat text-[18px]  font-normal leading-[150%] tracking-[0.36px]">
                        {list.blurb}
                      </p>
                    )}
                  </li>
