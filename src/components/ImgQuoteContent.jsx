  ...
  return (
    <section className="ImgQuoteContent bg-[#E5E4E7]">
      <div className="container">
        <div className="outer-wrap relative flex items-center w-[100%]">
          <div className="img-item relative w-[45%]">
            <div className="inner-contentblue absolute top-[-50px] left-[-50px] items-center flex w-[185px] h-[185px] text-center rounded-[100px] bg-[#fff] border-8 border-[#ED268B] ">
          ...
          <div className="content-item w-[55%]">
            <div className="content-wrap pl-[60px]">
              ...
              <div className="inner-wrap flex flex-wrap pt-[50px]">
                <div className="logo-wrap w-[30%] border-r border-black text-left flex items-center">
                  <div className="inner-icon relative max-w-[135px] h-[34px] z-2 w-full overflow-hidden">
                    <img
                ...
                <div className="inner-content w-[70%] pl-[70px] flex items-center">
