  ...
  const projects = [
    {
      ...
      link: "http://localhost:3002/about-us",
    },
    {
    ...
    },
    {
      ...
      link: "http://localhost:3002/ChefKitchen",
    },
    {
      title: "Contact Us",
      desc: "Live weather app using OpenWeather API with charts.",
    ...
    },
    {
      ...
      desc: "Live weather app using OpenWeather API with charts.",
      img: "https://via.placeholder.com/300x200/F59E0B/ffffff?text=Weather",
      link: "http://localhost:3002/crosspoint",
    },
    {
    ...
    },
    {
      ...
      desc: "Live weather app using OpenWeather API with charts.",
      img: "https://via.placeholder.com/300x200/F59E0B/ffffff?text=Weather",
      link: "http://localhost:3002/houston",
    },
    {
      title: "Mario",
      desc: "Live weather app using OpenWeather API with charts.",
      img: "https://via.placeholder.com/300x200/F59E0B/ffffff?text=Weather",
      link: "http://localhost:3002/mario",
    },
    {
      title: "Oxford",
      desc: "Live weather app using OpenWeather API with charts.",
      img: "https://via.placeholder.com/300x200/F59E0B/ffffff?text=Weather",
      link: "http://localhost:3002/oxford",
    },
    {
      title: "Solution Page",
      desc: "Live weather app using OpenWeather API with charts.",
      img: "https://via.placeholder.com/300x200/F59E0B/ffffff?text=Weather",
      link: "http://localhost:3002/Solution",
    },
    {
      title: "Weather Dashboard",
      desc: "Live weather app using OpenWeather API with charts.",
